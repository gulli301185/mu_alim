...
function FooterLink({ href, label }: { href: string; label: string }) {
  ...
  return <Link to={href} className="footer-link">{label}</Link>;
}
    ...
    <footer id="contact" className="footer-wave">
      <svg className="footer-wave-svg" viewBox="0 0 1440 120" preserveAspectRatio="none" aria-hidden>
        <path
          ...
          className="footer-wave-path-back"
        />
      </svg>
      <svg className="footer-wave-svg footer-wave-svg-front" viewBox="0 0 1440 100" preserveAspectRatio="none" aria-hidden>
        <path
          d="M0,70 L0,100 L1440,100 L1440,0 C1080,50 720,10 360,55 C180,75 60,65 0,70 Z"
          className="footer-wave-path-front"
        />
      </svg>
