...
export const PAYMENT_TERMS = [
  ...
  "Администратор төлөм реквизиттерин WhatsApp аркылуу жөнөтөт.",
  "Төлөгөндөн кийин төлөм чекин (скриншот) WhatsAppка жибериңиз.",
  "Чек текшерилгенден кийин менеджер админ панель аркылуу сабактарга доступ берет.",
  "Курс аяктаганда финалдык тест — 90% жана андан жогору болсо PDF сертификат.",
...
export const TEACHER = {
  ...
  quoteSub: "",
  heroQuote: "МАКСАТСЫЗ ӨМҮР – БАГЫТСЫЗ КЕМЕДЕЙ.",
  heroQuoteSub: "БАГЫТЫҢДЫ ТАП, АНАН ТОКТОБО.",
  heroTagline: "БИЛИМ – ЭРКИНДИК. ИЗДЕНҮҮ – ӨМҮР.",
  heroPillars: [
    { label: "БИЛИМ АЛ", icon: "book" as const },
    { label: "МАКСАТ КОЙ", icon: "goal" as const },
    { label: "ОЙЛОН", icon: "think" as const },
    { label: "АЛГА УМТУЛ", icon: "forward" as const },
  ] as const,
  teaserQuote: "ЖАШОО – ЭҢ УЛУУ МУГАЛИМ. АР БИР КҮНДҮ ЫРААЗЫЧЫЛЫК МЕНЕН ЖАША.",
  teaserBio:
    "Мухаммадалим Исаков — ислам билимин заманбап окутуу менен айкалыштырып, терең жана системалуу окутуу менен бирге адамдын руханий өсүшүнө жана үй-бүлөлөрдүн бекем болушуна салым кошуп келет.",
  ...
  bioParagraphs: [
    ...
    "Ал эл аралык деңгээлде билим алган, үй - бүлө баалуулуктары жөнүндө сөз көтөргөн, терроризмдин бардык түрүнө каршы чыгуучу аалым.",
  ] as const,
  awards: [
  ...
  education: [
    ...
    },
    {
      ...
      city: "Орто Азия",
      focus:
        "Орто Азиянын чыгаан аалымынын алдында ислам билимин тереңдетип окуган",
    },
    {
      period: "2016–2017",
      place: "Ислам билими",
      city: "Түркия",
      focus: "Түркияда билимин алган",
    },
    {
      period: "2017–2018",
    ...
    },
    {
      ...
      city: "Дубай, БАЭ",
      focus:
        "3 жыл катары менен Рамазан айларында тасаввуф жана хадис боюнча билим алган",
    },
    {
      period: "2021–2023",
  ...
  languages: [
    { name: "Кыргызча", level: "Эне тили", dots: 5 },
  ...
  interests: [
    ...
    { icon: "grad" as const, label: "Ислам билим берүү" },
    { icon: "scale" as const, label: "Фикх / хадис" },
    { icon: "culture" as const, label: "Маданият" },
    { icon: "search" as const, label: "Изденүү" },
  ] as const,
  stats: [
    { value: "1200+", label: "Баяндар" },
...
export const FAQ = [
  ...
  },
  {
    ...
    a: "Төлөм жургузгөндөн кийин жеке кабинетте бардык сабактар ачылат.",
  },
  {
    q: "Сертификат кандай берилет?",
    a: "Бардык сабактарды аяктап, тесттен 80% дан өйдө упай топтогондон кийин ПДФ форматында сертификат берилет .",
  },
] as const;
